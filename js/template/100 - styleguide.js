  ...
  function updateNavigation() {
    ...
    contentSections.each(function() {
      var actual = $(this),
        ...
        actualAnchor = $('.s_sidebar-nav').find('a[href="#'+actual.attr('id')+'"]');

      if ((parseInt(actual.offset().top - paddingTop ) <= $(window).scrollTop() ) &&
         (parseInt(actual.offset().top + actualHeight - paddingTop) > $(window).scrollTop() +1)) {
