/**
 * lato_styleguide
 * https://github.com/LatoTeam/lato_styleguide
 * Copyright 2016 Lato Team
...
gulp.task('serve', ['styles', 'scripts'], () => {
  ...
  gulp.watch(['./src/js/template/*.js'], ['scripts', reload]);
});
...
gulp.task('default', ['clean'], () => {
  ...
  runSequence('serve', () => {
    ...
    console.log('\x1b[32m  BRick is ready to Rock! - Search Brick on github\x1b[0m\n');
    console.log('\x1b[42m************************************\x1b[0m\n');
